   ...
   render() {
      ...
      return (
          <div className="App" ref={el => (this.componentRef = el)} >
            <ReactToPrint
              trigger={() => <button style={{position: 'absolute'}} class="btn btn-success">In Chi Tiết Hợp Đồng</button>}
            ...
            />
              ...
              <div className="A4 page">
                <div className="section" style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center', color: 'white'}}>
