export const WORK_MANAGER = {
  schedule_completed: 'Đã hoàn thành chia việc cho nhân viên',
  schedule_changes: 'Đã cập nhật chia việc cho nhân viên',
  meeting_sale_completed: 'Đã hoàn thành họp với Sale',
...
export const MODAL = {
  ...
  ekip_meeting_complete_title: 'Xác nhận hoàn thành họp ekip',
  ekip_meeting_complete_body: 'Bạn có chắc chắn hoàn thành họp ekips',

};


export const PROGRESS = {
  caring: 'Chăm sóc (10 ngày)',
  sale_meeting: 'Họp sale (5 ngày)',
